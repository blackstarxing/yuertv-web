...
router.get('/activity/datashow', function(req, res, next) {
    ...
    Thenjs.parallel([function(cont) {
        ...
        res.render('activity/datashow', {
            ...
            first_live_date_date_month:JSON.parse(result[1]).object.first_live_date_date.split('-')[1],
            first_live_date_date_day:JSON.parse(result[1]).object.first_live_date_date.split('-')[2],
